...
function createOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca-org${HOST_ORG} --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client register --caname ca-org${HOST_ORG} --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering orderer0"
  set -x
  fabric-ca-client register --caname ca-org${HOST_ORG} --id.name orderer0 --id.secret orderer0pw --id.type orderer --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering user"
  set -x
  fabric-ca-client register --caname ca-org${HOST_ORG} --id.name user1 --id.secret user1pw --id.type client --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Registering the org admin"
  set -x
  fabric-ca-client register --caname ca-org${HOST_ORG} --id.name org${HOST_ORG}admin --id.secret org${HOST_ORG}adminpw --id.type admin --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null

  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:7054 --caname ca-org${HOST_ORG} -M ${PWD}/organizations/peerOrganizations/org${HOST_ORG}.example.com/peers/peer0.org${HOST_ORG}.example.com/msp --csr.hosts peer0.org${HOST_ORG}.example.com --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:7054 --caname ca-org${HOST_ORG} -M ${PWD}/organizations/peerOrganizations/org${HOST_ORG}.example.com/users/User1@org${HOST_ORG}.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://org${HOST_ORG}admin:org${HOST_ORG}adminpw@localhost:7054 --caname ca-org${HOST_ORG} -M ${PWD}/organizations/peerOrganizations/org${HOST_ORG}.example.com/users/Admin@org${HOST_ORG}.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org${HOST_ORG}/tls-cert.pem
  { set +x; } 2>/dev/null
