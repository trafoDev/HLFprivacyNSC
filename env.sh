...
# Environment variables for Org1
  ...
  #export ORDERER_CA=/organizations/peerOrganizations/org1.example.com/orderers/orderer0.org1.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
}
...
# Environment variables for Org2
  ...
  export ORDERER_CA=${PWD}/organizations/peerOrganizations/org2.example.com/orderers/orderer0.org2.example.com/tls/tlscacerts/tls-localhost-8054-ca-org2.pem
}
