...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export ORDERER_ADDRESS=orderer0.org1.example.com:7050
    ...
    export ORDERER_ADDRESS=orderer0.org2.example.com:7050
    ...
    export ORDERER_ADDRESS=orderer0.org3.example.com:7050
